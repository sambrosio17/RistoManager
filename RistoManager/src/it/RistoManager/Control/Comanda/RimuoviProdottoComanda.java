...
/**
 * Servlet implementation class RimuoviProdottoComanda
 */
@WebServlet("/removeComanda")
public class RimuoviProdottoComanda extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RimuoviProdottoComanda() {
        super();
