...
public class AggiungiProdottoComanda extends HttpServlet {
     ...
     */
    public AggiungiProdottoComanda() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		synchronized (session) {
			...
			int quantity=(request.getParameter("quantita")==null || request.getParameter("quantita").isEmpty()) ? 1 : Integer.parseInt(request.getParameter("quantita"));
